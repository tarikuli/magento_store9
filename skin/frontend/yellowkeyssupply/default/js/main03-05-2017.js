...
jQuery(window).load(function(){
   ...
   jQuery('.search-keys .vehicle-model').change(function(e){
    ...
    jQuery('body:not(.customer-account-login):not(.customer-account-create):not(.cms-account-awaiting-approval):not(.customer-account-forgotpassword) .ui.basic.modal').modal({
      closable:false
    }).modal("show");
