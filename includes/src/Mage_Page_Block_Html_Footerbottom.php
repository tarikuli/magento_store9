 ...
 */
class Mage_Page_Block_Html_Footerbottom extends Mage_Core_Block_Template {
	...
	public function getBackgroundImage($image = "") {
		...
		$sql = $connection->query("select * from $tblname where status='0' and groupname='footer_banner' ORDER BY imageorder ASC Limit 1");
		$row1 = $sql->fetch();
