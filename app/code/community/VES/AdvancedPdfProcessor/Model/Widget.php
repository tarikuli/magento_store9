<?php
class VES_AdvancedPdfProcessor_Model_Widget extends Varien_Object
{
    /**
    ...
    public function getWidgetDeclaration($type, $params = array(), $asIs = true)
    {
        ...
        $imageName = Mage::helper('advancedpdfprocessor')->getCustomImageFileName();
        if (is_file(Mage::helper('advancedpdfprocessor')->getCustomPlaceholderImagesBaseDir() . DS . $imageName)) {
            $image = Mage::helper('advancedpdfprocessor')->getCustomPlaceholderImagesBaseUrl() . $imageName;
        } else {
