 ...
 */
class VES_AdvancedPdfProcessor_Adminhtml_WidgetController extends Mage_Adminhtml_Controller_Action
{
    /**
    ...
    public function loadOptionsAction()
    {
        try {
            ...
            if ($paramsJson = $this->getRequest()->getParam('widget')) {
                ...
                if (is_array($request)) {
                    $optionsBlock = $this->getLayout()->getBlock('easypdf_wysiwyg_widget.options');
    ...
    public function buildWidgetAction()
    {
        ...
        $html = Mage::getSingleton('advancedpdfprocessor/widget')->getWidgetDeclaration($type, $params, $asIs);
