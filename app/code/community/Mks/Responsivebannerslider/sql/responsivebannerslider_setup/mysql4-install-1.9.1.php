...
$sql = <<<SQLTEXT
create table {$this->getTable('mksresponsivebannerslider')} (id int not null auto_increment, title varchar(255), groupname varchar(255),image varchar(255),description varchar(255),url varchar(255),imageorder varchar(255),status varchar(255), primary key(id));
