<?php
class Magestore_Webpos_Block_Adminhtml_Sales_Order_View_Tab_Survey
	...
	public function _construct()	{
		parent::_construct();
		$this->setTemplate('webpos/sales/order/view/tab/survey.phtml');
	}

	public function getTabLabel()	{
		return Mage::helper('webpos')->__('Survey Information');
	}
