 ...
 */
class Magestore_Webpos_Block_Adminhtml_Webpos_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('webposGrid');
        $this->setDefaultSort('webpos_id');
     ...
     *
     * @return Magestore_Webpos_Block_Adminhtml_Webpos_Grid
     */
    protected function _prepareCollection()
    {
        $collection = Mage::getModel('webpos/webpos')->getCollection();
    ...
    {
        $this->addColumn('webpos_id', array(
        ...
        $this->addColumn('title', array(
            'header'    => Mage::helper('webpos')->__('Title'),
            'align'     =>'left',
            'index'     => 'title',
        ));

        $this->addColumn('content', array(
            'header'    => Mage::helper('webpos')->__('Item Content'),
            'width'     => '150px',
            'index'     => 'content',
        ));
    ...
    {
        $this->setMassactionIdField('webpos_id');
