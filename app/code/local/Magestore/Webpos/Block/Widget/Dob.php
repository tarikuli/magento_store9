...
class Magestore_Webpos_Block_Widget_Dob extends Mage_Customer_Block_Widget_Dob
{
    /**
     * Date inputs
     *
    ...
    {
        return (bool)Mage::getStoreConfig('webpos/field_require_management/birthday');
    }
