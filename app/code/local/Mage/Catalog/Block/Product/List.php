...
class Mage_Catalog_Block_Product_List extends Mage_Catalog_Block_Product_Abstract
{
    ...
    public function productLabel($id){
        /*
        if(Mage::getModel('catalog/product')->load($id)->getData('newarrival')) {
            return '<span class="product-label newarrival">New</span>';
        }elseif(Mage::getModel('catalog/product')->load($id)->getData('onsale')){
            return '<span class="product-label onsale">Sale</span>';
        }     
        */ 
    }

     public function productLabelNew(){
        return '<span class="product-label newarrival">New</span>';
     }

    public function productLabelSale(){
        return '<span class="product-label onsale">Sale</span>';
    }
    ...
    public function getSKUPriceSummaryHtml($_product,$_productNameStripped, $is_list){
       $html=  '<a href="'.$_product->getProductUrl().'" title="'. $_productNameStripped .'">';
        ...
        $html .='<div class="product-description">
                <div class="product-model">'.$this->displayFCCModel($_product).'</div>
                <div>SKU: '.$_product->getSKU().'</div>
            </div>
        </a>';
        return $html;
    }
